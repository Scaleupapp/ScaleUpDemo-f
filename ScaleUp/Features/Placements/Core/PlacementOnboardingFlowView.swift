...
/// First-login hook for placement (institution) students — a 2-step welcome
...
/// `resolveLaunchState` stays unchanged. The season screen's CTA calls
/// `AppState.finishPlacementOnboarding()`, which marks the student
